...
document.addEventListener(
	...
	function () {
		if (document.getElementById("countdownclock")) {
			...
			var currentTime = countdownOptions.timezone
				? moment().tz(countdownOptions.timezone)
				: moment();

			if (countdownOptions.start) {
				eventStart = countdownOptions.timezone
					? moment.tz(countdownOptions.start, countdownOptions.timezone)
					: Date.parse(countdownOptions.start);
			}

			if (countdownOptions.end) {
				eventEnd = countdownOptions.timezone
					? moment.tz(countdownOptions.end, countdownOptions.timezone)
					: Date.parse(countdownOptions.end);
			}
