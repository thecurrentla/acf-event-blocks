...
class ACF_Event_Schedule_Plugin {
	...
	*/
	public function acfes_enqueue_scripts() {
		...
		wp_register_script( 'acfes-schedule-now-line', plugin_dir_url( __FILE__ ) . 'assets/js/now-line.js', array(), filemtime( plugin_dir_path(__FILE__) . 'assets/js/now-line.js' ), true );
